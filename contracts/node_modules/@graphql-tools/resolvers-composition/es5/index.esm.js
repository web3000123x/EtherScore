...
function chainFunctions(funcs) {
    ...
    return funcs.reduce(function (a, b) { return function () {
        ...
        return a(b.apply(void 0, __spreadArray([], __read(args))));
    }; });
}
...
function composeResolvers(resolvers, mapping) {
    ...
    Object.keys(mappingResult).forEach(function (path) {
        var fns = chainFunctions(__spreadArray(__spreadArray([], __read(asArray(mappingResult[path]))), [function () { return get(resolvers, path); }]));
