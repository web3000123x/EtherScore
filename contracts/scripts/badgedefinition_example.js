...
module.exports = async function main(callback) {
    try {
      ...
      console.log("The 1st badge will be called example#" + token_number + " (will be claimed)");
      console.log("The 2nd badge will be called example#" + token_number2 + " (will be droped)");
      ...
      // (badge 1)
      await badgeDefinitionFactory.createBadgeDefinition("example#" + token_number, "this is the example#" + token_number, ["a tag", "another tag"], "https://i.redd.it/rq36kl1xjxr01.png", false);
      ...
      console.log("createBadgeDefinition: The new BadgeDefinitionId for badge example#" + token_number, "is", badgeId.toString());

      // (badge 2)
      await badgeDefinitionFactory.createBadgeDefinition("example#" + token_number2, "this is the example#" + token_number2, ["a tag", "another tag"], "https://i.redd.it/rq36kl1xjxr01.png", false);
      
      await badgeDefinitionFactory.getPastEvents( 'Transfer', { fromBlock: 'latest', toBlock: 'latest' } )
      .then(function(events){
          badgeId2 = events[0]["returnValues"]["tokenId"];
      });
      console.log("createBadgeDefinition: The new BadgeDefinitionId for badge example#" + token_number2, "is", badgeId2.toString());
      ...
      // (badge 1)
      await badgeDefinitionFactory.addBadgeAttributionCondition(badgeId, "condition1 of example#" + token_number, "thegraph", "uniswap", query, operator, condition);

      // (badge 2)
      await badgeDefinitionFactory.addBadgeAttributionCondition(badgeId2, "condition1 of example#" + token_number2, "thegraph", "uniswap", query, operator, condition);
